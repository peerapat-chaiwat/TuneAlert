...
public final class Song {
    ...
    /**
     * สร้างเพลง
     * @param title คือ ชื่อเพลง
     * @param artist คือ ศิลปิน
     * @param tags  คิแ ชนิดของเพลง ex. pop rock jazz 
     * @throws IllegalArgumentException เมื่อ title artist tags = null , ""
     */
    public Song(String title, String artist, List<String> tags) {
        ...
        if(tags  == null || tags.contains("") || tags.contains(null)) throw new IllegalArgumentException("tags error");
        this.title = title;
        this.artist = artist;
